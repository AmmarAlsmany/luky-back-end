            ...
            <table class="table align-middle mb-0 table-hover table-centered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Tech Lead</td>
                        <td>
                            <a href="#!" class="link-primary">{{ __('users.add_workspace') }}</a>
                        </td>
                        ...
                        <td> <a href="#!" class="link-primary">{{ __('users.add_user') }}</a></td>
                        <td>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked4">
                            </div>
    ...
    <div class="row g-0 align-items-center justify-content-between text-center text-sm-start p-3 border-top">
        <div class="col-sm">
            <div class="text-muted">
                {{ __('users.showing') }} <span class="fw-semibold">10</span> {{ __('users.of') }} <span class="fw-semibold">59</span> {{ __('users.results') }}
            </div>
        </div>
